...
static struct msm_gpiomux_config msm_blsp_configs[] __initdata = {
	{
		.gpio      = 12,	       /* BLSP1 UART TX */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gpio_uart_config,
		},
	},
	{
		.gpio      = 13,	       /* BLSP1 UART RX */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gpio_uart_config,
		},
	},
...
static struct gpiomux_setting gpio_led_i2c_config = {
	.func = GPIOMUX_FUNC_1,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_IN,
...
static struct msm_gpiomux_config mdm9630_led_i2c_config[] __initdata = {
	{
		.gpio = 59,
		.settings = {
			[GPIOMUX_ACTIVE]    = &gpio_led_i2c_config,
			[GPIOMUX_SUSPENDED] = &gpio_led_i2c_config,
		},
	},
	{
		.gpio = 60,
...
static struct gpiomux_setting led_en_config = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_OUT_HIGH,
...
static struct msm_gpiomux_config mdm9630_led_en_config[] __initdata = {
	{
		.gpio = 56,
		.settings = {
			[GPIOMUX_SUSPENDED] = &led_en_config,
		},
	},
};
...
static struct gpiomux_setting wps_key_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_UP,
	.dir = GPIOMUX_IN,
...
static struct msm_gpiomux_config functions_wps_key_configs[] __initdata = {
	{
		.gpio = 20,
		.settings = {
			[GPIOMUX_SUSPENDED] = &wps_key_cfg,
		},
	},
};
...
void __init mdm9630_init_gpiomux(void)
{
	...
	msm_gpiomux_install(mdm9630_led_i2c_config, ARRAY_SIZE(mdm9630_led_i2c_config));
	msm_gpiomux_install(mdm9630_led_en_config, ARRAY_SIZE(mdm9630_led_en_config));
	msm9630_disp_init_gpiomux();
	msm_gpiomux_install(functions_wps_key_configs, ARRAY_SIZE(functions_wps_key_configs));	
}
